...
func pintarInformacionMision(mision_id):
	...
	icono_mision.texture = load(informacion.get("icono", "res://addons/GestorDeMisiones/editor/icons/iconoMisionGemas_01.png"))
